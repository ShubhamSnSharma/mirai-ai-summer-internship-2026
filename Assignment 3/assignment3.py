'''
the upgraded version of the webapp that was discussed 
in session-2 live class which was our asignment-2 
is also assignment-3. 
Since all the requirements are already met and all that 
remains is making a demo video showing the working
'''
...
# handling errors
if not personality:
    st.info("Please choose a personality from the side-bar first.")
    
elif not user_message:
    st.info("Please type a message to start conversing with the character.")
